...
!(function() {
  ...
  (gt.prototype = {
    ...
    then: function(t, e) {
      ...
      return (
        ...
        this._state === J || this._state === tt ? ot(ct, n) : this._then.push(n),
        n.then
      );
    },
    catch: function(t) {
  ...
  function jt(t) {
    var e = t.icons,
      ...
      b = [$.replacementClass, i ? ''.concat($.familyPrefix, '-').concat(i) : '', v]
        .filter(function(t) {
    ...
    m && (y.attributes[Z] = ''),
      s &&
        y.children.push({
          tag: 'title',
          attributes: { id: y.attributes['aria-labelledby'] || 'title-'.concat(f || kt()) },
          children: [s]
        });
    var w,
      x,
        ...
        a.found && n.found
          ? ((k = (w = V).children),
            ...
            (I = {
              ...
              children: [Et(Q({ tag: M.tag, attributes: Q({}, M.attributes, j.path) }, R))]
            }),
  ...
  var Rt = function() {},
    It = $.measurePerformance && f && f.mark && f.measure ? f : { mark: Rt, measure: Rt },
    _t = 'FA "5.14.0"',
    Tt = function(t) {
  ...
  function Jt(t) {
    return t.reduce(function(t, e) {
      ...
      if (Kt[e]) t.prefix = e;
      else if ($.autoFetchSvg && -1 < ['fas', 'far', 'fal', 'fad', 'fab', 'fa'].indexOf(e))
        t.prefix = e;
      else if (n) {
  ...
  function fe(t) {
    var e,
      ...
      g =
        ...
        $.autoA11y &&
          (o
            ? (i['aria-labelledby'] = ''.concat($.replacementClass, '-title-').concat(c || kt()))
      ...
      children: [
        pe,
        {
          ...
          children: [
            {
              tag: 'animate',
              attributes: Q({}, me, { attributeName: 'r', values: '28;14;28;28;14;28;' })
            },
            { tag: 'animate', attributes: Q({}, he, { values: '1;0;1;1;0;1;' }) }
          ]
        },
        {
          tag: 'path',
          ...
          children: [{ tag: 'animate', attributes: Q({}, he, { values: '1;0;0;0;0;1;' }) }]
        },
        {
          tag: 'path',
          attributes: Q({}, de, {
          ...
          children: [{ tag: 'animate', attributes: Q({}, he, { values: '0;0;1;1;0;0;' }) }]
        }
      ]
    },
    ve = W.styles;
  function be(t) {
    ...
    return {
      ...
      icon: Array.isArray(a)
        ? {
            tag: 'g',
            attributes: { class: ''.concat($.familyPrefix, '-').concat(Y.GROUP) },
            children: [
              {
                tag: 'path',
                attributes: {
  ...
  function Ce(m, p) {
    ...
    return new vt(function(a, t) {
      ...
      if (r && 'none' !== o && '' !== o) {
        var c = ~['Solid', 'Regular', 'Light', 'Duotone', 'Brands'].indexOf(r[1])
            ? E[r[1].toLowerCase()]
            : R[i],
    ...
    Te =
      ...
      function(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          n = (t || {}).icon ? t : je(t || {}),
          a = e.mask;
        return a && (a = (a || {}).icon ? a : je(a || {})), Le(n, Q({}, e, { mask: a }));
      }),
    Ye = {
      noAuto: function() {
          ...
          return (
            ...
            (function(t) {
              var e = t.content,
                n = t.title,
                a = t.extra,
                r = Q({}, a.attributes, n ? { title: n } : {}, { class: a.classes.join(' ') }),
                i = Pt(a.styles);
