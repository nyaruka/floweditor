    ...
    describe('render >', () => {
        it('should render empty case', () => {
            ...
            const {
                ...
                onChangeArguments,
                onChangeExitName
            } = empty.instance() as any;

            expect(getSpecWrapper(empty, 'case-form').props()).toEqual(
            ...
            expect(getSpecWrapper(empty, 'operator-list').props()).toEqual(
                expect.objectContaining({
            ...
            expect(getSpecWrapper(empty, 'args-input').props()).toEqual({
            ...
            expect(getSpecWrapper(empty, 'exit-input').props()).toEqual({
        ...
        cases.forEach((kase, idx) => {
            ...
            const wrapper = shallow(<CaseElement {...caseProps} />);

            it('should render FormElements with expected props', () =>
                expect(getSpecWrapper(wrapper, 'case-form').props()).toEqual(
                    expect.objectContaining({
                        name: caseProps.name,
                        errors: []
                    })
            ...
            it('should render operator lists w/ expected props', () =>
                expect(
                    getSpecWrapper(wrapper, 'operator-list').props()
                ).toEqual(
                    expect.objectContaining({
                        value: kase.type
                    })
            ...
            it('should render arguments inputs w/ expected props', () =>
                expect(getSpecWrapper(wrapper, 'args-input').props()).toEqual(
                    expect.objectContaining({
                        value:
            ...
            it('should render exit inputs w/ expected props', () =>
                expect(getSpecWrapper(wrapper, 'exit-input').props()).toEqual(
                    expect.objectContaining({
    ...
    describe('instance methods >', () => {
        describe('onChangeOperator >', () => {
            ...
            it("should update state operator config to the value it's passed if value is different than operatorConfig in state", () => {
                ...
                expect(wrapper.state('operatorConfig')).toEqual(
                    allWordsOperator
                );
            });
