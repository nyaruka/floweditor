...
import { Type, getTypeConfig } from '../../../config';
...
const addGroupConfig: Type = getTypeConfig('add_to_group');
const removeGroupConfig: Type = getTypeConfig('remove_from_group');
