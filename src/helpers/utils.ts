...
export const toBoolMap = (array: string[]): BoolMap =>
    array.reduce((map: BoolMap, item: string) => {
        map[item] = true;
        return map;
    }, {});
...
export const getSpecWrapper = (
    ...
    specName: string,
    specAttrName: string = 'data-spec'
): any => componentWrapper.find(`[${specAttrName}="${specName}"]`);
...
// Compare basic objects (no methods and DOM nodes)
// Property order important
// prettier-ignore
export const jsonEqual = (a: {}, b: {}): boolean =>
